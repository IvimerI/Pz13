/* =========================================================
   ...
   Автор: заполните в README.md
   ========================================================= */

-- =========================================================
-- 1. Создание базы данных
-- =========================================================
IF DB_ID('AssetManagementDB1') IS NULL
BEGIN
    CREATE DATABASE AssetManagementDB1;
END;
GO

USE AssetManagementDB1;
GO
...
INSERT INTO asset_mgmt.system_users (user_code, employee_code, login_name, role_code, is_active, is_blocked) VALUES
('USR001', 'EMP001', 'login01', 'ADMIN',   1, 0),
('USR002', 'EMP002', 'login02', 'ADMIN',   1, 0),
('USR003', 'EMP003', 'login03', 'MANAGER', 1, 0),
('USR004', 'EMP004', 'login04', 'MANAGER', 1, 0),
('USR005', 'EMP005', 'login05', 'MANAGER', 1, 0),
('USR006', 'EMP006', 'login06', 'MANAGER', 1, 0),
('USR007', 'EMP007', 'login07', 'MANAGER', 1, 0),
('USR008', 'EMP008', 'login08', 'MANAGER', 1, 0),
('USR009', 'EMP009', 'login09', 'USER',    1, 0),
('USR010', 'EMP010', 'login10', 'USER',    1, 0),
('USR011', 'EMP011', 'login11', 'USER',    1, 0),
('USR012', 'EMP012', 'login12', 'USER',    1, 0),
('USR013', 'EMP013', 'login13', 'USER',    1, 0),
('USR014', 'EMP014', 'login14', 'USER',    1, 0),
('USR015', 'EMP015', 'login15', 'USER',    1, 0),
('USR016', 'EMP016', 'login16', 'USER',    1, 0),
('USR017', 'EMP017', 'login17', 'USER',    1, 0),
('USR018', 'EMP018', 'login18', 'USER',    1, 0),
('USR019', 'EMP019', 'login19', 'USER',    1, 0),
('USR020', 'EMP020', 'login20', 'USER',    1, 0);
GO
...
BEGIN
    ...
    (
        ...
        status_code, location_code, responsible_code, vendor_code, notes
    )
    VALUES
    (
        @asset_code,
